...
import cl.duoc.bancoxyz.bff.movil.config.JwtProperties;
...
public class JwtTokenUtil {
    ...
    public boolean validateToken(String token, UserDetails userDetails) {
        ...
        boolean audOk = claims.getAudience() != null && claims.getAudience().contains("MOVIL");
